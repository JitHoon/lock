...
var deleteComments = document.querySelectorAll(".delete_comment");
var addComment = function addComment(text, id) {
  var commentContainer = document.querySelector(".question_garden_grid");
  var commentList = document.createElement("i");
...
var handleSubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var text, questionId, response, _yield$response$json, newCommentId;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            text = textarea.value;
            questionId = questionContainer.dataset.id;
            if (!(text === "")) {
              _context.next = 5;
              break;
            }
          ...
          case 5:
            _context.next = 7;
            return (0, _nodeFetch["default"])("/qna/".concat(questionId, "/comment"), {
              method: "POST",
              headers: {
...
var handleDelete = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var commentList, commentId, questionId, response;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            questionId = questionContainer.dataset.id;
            _context2.next = 5;
            return (0, _nodeFetch["default"])("/qna/".concat(commentId, "/commentdelete"), {
              method: "DELETE",
              headers: {
