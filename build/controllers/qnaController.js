...
exports.seeQ = exports.searchQ = exports.postUploadQ = exports.postEditQ = exports.mainQ = exports.getUploadQ = exports.getEditQ = exports.deleteQ = exports.deleteComment = exports.createComment = void 0;
...
var mainQ = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _Question["default"].find({}).sort({
              createdAt: "desc"
            });
          case 2:
            questions = _context.sent;
            return _context.abrupt("return", res.render("qna/mainQ", {
              pageTitle: "Q&A",
              questions: questions
            }));
          case 4:
  ...
  return function mainQ(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.mainQ = mainQ;
var searchQ = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            return _context2.abrupt("return", res.render("qna/searchQ", {
              pageTitle: "Q&A",
              questions: questions
            }));
          case 8:
  ...
  return function searchQ(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.searchQ = searchQ;
var seeQ = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            id = req.params.id;
            _context3.next = 3;
            return _Question["default"].findById(id).populate("owner");
          case 3:
            _context3.next = 5;
            return _context3.sent.populate("comments");
          case 5:
          ...
          case 8:
            return _context3.abrupt("return", res.render("qna/seeQ", {
              pageTitle: "Q&A",
              question: question
            }));
          case 9:
  ...
  return function seeQ(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
exports.seeQ = seeQ;
var getUploadQ = function getUploadQ(req, res) {
  return res.render("qna/uploadQ", {
    pageTitle: "질문 업로드"
  });
};
exports.getUploadQ = getUploadQ;
var postUploadQ = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _id, content, now, kr, newQuestion, user;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            ...
            user.save();
            return _context4.abrupt("return", res.redirect("/qna"));
          case 16:
            _context4.prev = 16;
            _context4.t0 = _context4["catch"](4);
            console.log(_context4.t0);
            return _context4.abrupt("return", res.status(400).render("qna/uploadQ", {
              pageTitle: "질문 업로드",
  ...
  return function postUploadQ(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
exports.postUploadQ = postUploadQ;
var getEditQ = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 9:
            return _context5.abrupt("return", res.render("qna/editQ", {
              pageTitle: "질문 수정",
              question: question
            }));
          case 10:
  ...
  return function getEditQ(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
exports.getEditQ = getEditQ;
var postEditQ = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _id, id, content, question;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 12:
            return _context6.abrupt("return", res.redirect("/qna"));
          case 13:
          case "end":
  ...
  return function postEditQ(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
exports.postEditQ = postEditQ;
var deleteQ = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 11:
            return _context7.abrupt("return", res.redirect("/qna"));
          case 12:
          case "end":
  ...
  return function deleteQ(_x13, _x14) {
...
var createComment = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var user, text, id, question, commentUser, comment;
  ...
  return function createComment(_x15, _x16) {
...
var deleteComment = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var id, questionId, user, question, commentUser;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            id = req.params.id, questionId = req.body.questionId, user = req.session.user;
            _context9.next = 3;
            return _Question["default"].findById(questionId);
          case 3:
          ...
          case 6:
            ...
            return _context9.abrupt("return", res.sendStatus(403));
          case 10:
